...
const ACR_ACCESS_SECRET = 'EIGwGoSx8DZX8Vc22xqLIlEarQUfTKcNtwcaj3p';
// =======================
...
// Render's free plan sleeps a service if it gets no HTTP traffic for a while.
// This tiny web server gives it something to "wake up" on — pair it with a free
// uptime pinger (e.g. UptimeRobot) that visits this URL every 5 minutes.
...
http
  ...
  .listen(PORT, () => console.log(`Keep-alive server ${PORT}-portda ishlamoqda.`));
